...
let ``Count measurements should return 7 for example input`` () =
    let measurements = [ 199; 200; 208; 210; 200; 207; 240; 269; 260; 263; ] |> List.map Day1.Measurement
...
let ``Sum of a sliding window should return correct value`` () =
    let window = Day1.SlidingWindow(Day1.Measurement 199, Day1.Measurement 200, Day1.Measurement 208)
